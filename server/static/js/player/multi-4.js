...
function colour(correct) {
    if (correct==="A") {
        ...
        document.getElementById("D").classList.add("incorrect-soft")
    } else if (correct==="B") {
...
function d() {if (answered===false){answer("D");answered=true;document.getElementById("progress").setAttribute("value", progress.toString());newprogress = progress + 1;}};
...
// Set Question 4
document.getElementById(buttons[3]).innerHTML = buttons[3]+": "+answers[3]
